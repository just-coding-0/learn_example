...
type (
	History interface {
		...
		Last(ctx context.Context, in *LastRequest) (*LastResponse, error)
...
func (m *defaultHistory) Last(ctx context.Context, in *LastRequest) (*LastResponse, error) {
...
func (m *defaultHistory) Get(ctx context.Context, in *GetRequest) (*GetResponse, error) {
