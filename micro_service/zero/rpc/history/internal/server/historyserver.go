...
import (
	...
	"github.com/just-coding-0/learn_example/micro_service/zero/rpc/history/internal/logic"
...
func (s *HistoryServer) Last(ctx context.Context, in *history.LastRequest) (*history.LastResponse, error) {
	l := logic.NewLastLogic(ctx, s.svcCtx)
	return l.Last(in)
}

func (s *HistoryServer) Get(ctx context.Context, in *history.GetRequest) (*history.GetResponse, error) {
